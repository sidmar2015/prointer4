...
String list_IMEI[MAX]   = {"0000000000","1111111111","2222222222","3333333333"};//lista de IMEI's com permissão de acesso
...
// verificar acesso
int verif_permissao(String arg0){   //recebe como parâmetro o IMEI+senha recebidos por Bluetooth
      for(int i = 0; i < MAX; i++){ //percorre todos os IMEI's e senha cadastrados para verificar acesso
          ...
          else if(arg0 == (list_IMEI[i] + list_senha[i])){
...
int main(){
    ...
    switch(permissao){                        
      ...
      bluetooth.write("   Bem Vindo");        //envia a string via bluetooth
      lcd.setCursor(0,0);                     //seta o cursor na 1ª coluna da 1ª linha do LCD
      ...
      bluetooth.write("Tente novamente");   //envia via bluetooth
      lcd.setCursor(0,0);                   //seta o cursor na 1ª coluna da 1ª linha do LCD
